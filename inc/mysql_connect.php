...
mysql_connect('localhost','root','3Kd?q6RaBsDKo') or die(mysql_error());

mysql_select_db('jfkpvnbz_optimumtents')  or die(mysql_error());
...
$background = '<img class="hide-on-small-only" src="img/backgrounds/grand-canyon.jpg" alt="Backpacker overlooking the Grand Canyon"> <img class="show-on-small" src="img/backgrounds/grand-canyon-small.jpg" alt="Backpacker overlooking the Grand Canyon">';
