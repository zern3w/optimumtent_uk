...
<?php
				...
				while($res=mysql_fetch_array($query))
			{
			 ...
			 // Show Data in Table.
				...
				echo '<td class="white"><a name="'.$res['aname'].'"></a><img src="img/tables/'.$res['Image'].'" alt="'.$res['Brand'].' '.$res['Model'].' '.$res['Type'].'" border=0/><br />'.$res['Model'].'<br /><br /></td>';
				...
				echo '<a href="http://www.amazon.com/exec/obidos/ASIN/'.$res['Asin']. '/optad-20#customerReviews"  rel="nofollow" target="_blank">'.$ReadReviews.'</a></td>';
				...
				echo '<br /><a href="http://www.amazon.com/exec/obidos/ASIN/'.$res['Asin']. '/optad-20" rel="nofollow" target="_blank">'.$CheckInStock.'</a>';

				echo '</td>';

				echo '<td>'.$res['LBS'].' lb '.$res['OZ'].' oz</td>';
				...
				echo '<img src="img/tables-js/percent-sign.png" alt="percent sign"></font></td>';
