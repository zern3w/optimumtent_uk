	...
	<div class="card grey lighten-5 z-depth-2 menu-bottom hide-on-small-only">
		<div class="card-content hoverable">
			<span class="card-title"><h4 class="brown-text">TOC Page Sections</h4></span>
				<br />
					<blockquote>
						<a href="#specs">Specs & Setup Time</a>
					</blockquote>
					<blockquote>
						<a href="#size">Size, Height and Weight</a>
					</blockquote>
					<blockquote>
						<a href="#doors">Doors and Unique Features</a>
					</blockquote>
					<blockquote>
						<a href="#warranty">Warranty and Spare Parts</a>
					</blockquote>
					<blockquote>
						<a href="#reviews">Reviews and Overall Score</a>
						</blockquote>
				<br />
