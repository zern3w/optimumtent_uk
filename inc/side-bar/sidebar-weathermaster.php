	...
	<div class="card grey lighten-5 z-depth-2 menu-bottom hide-on-small-only">
		<div class="card-content hoverable">
			<span class="card-title"><h4 class="brown-text">TOC Page Sections</h4></span>
				<br />
					<blockquote>
						<a href="#specifications-and-features">Specifications &amp Features</a>
					</blockquote>
					<blockquote>
						<a href="#setuptimeandmanual">Setup, Instructions and Manual</a>
					</blockquote>
					<blockquote>
						<a href="#warrantyandspareparts">Features Warranty and Parts</a>
					</blockquote>
					<blockquote>
						<a href="#whatisincluded">What is included?</a>
					</blockquote>
					<blockquote>
						<a href="#reviewsandratings">Reviews and Price!</a>
					</blockquote>
				<br />
