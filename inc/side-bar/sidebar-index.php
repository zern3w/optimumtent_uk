	...
	<div class="card grey lighten-5 z-depth-2 menu-bottom hide-on-small-only">
		<div class="card-content hoverable">
			<span class="card-title"><h4 class="brown-text">TOC Page Sections</h4></span>
				<p>
					<blockquote><a href="#popular-tents">Popular Tents</a></blockquote>
					<blockquote><a href="#featured-tents">Featured Tents</a></blockquote>
					<blockquote><a href="#choosing-a-tent">Choosing a Tent</a></blockquote>
					<blockquote><a href="#different-types-of-tents">Different Types of Tents</a></blockquote>
				<br />
