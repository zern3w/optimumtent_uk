	...
	<div class="card grey lighten-5 z-depth-2 menu-bottom hide-on-small-only">
		<div class="card-content hoverable">
			<span class="card-title"><h4 class="brown-text">TOC Page Sections</h4></span>
				<br />
					<blockquote>
						<a href="#cabin-tents">Cabin Tents</a>
					</blockquote>
					<blockquote>
						<a href="#dome-tents">Dome Tents</a>
					</blockquote>
					<blockquote>
						<a href="#large-tents">Large Tents</a>
					</blockquote>
					<blockquote>
						<a href="#4-person-tents">4 Person Tents</a>
					</blockquote>
					<blockquote>
						<a href="#6-person-tents">6 Person Tents</a>
					</blockquote>
					<blockquote>
						<a href="#easy-to-set-up-tent">Easy to set up Tents</a>
					</blockquote>
					<blockquote>
